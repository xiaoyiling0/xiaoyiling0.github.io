...
export class LAppModel extends CubismUserModel {
  ...
  public update(): void {
    ...
    if (this._motionManager.isFinished()) {
      LAppPal.printMessage(`在更新里，待机动作执行一次`);
  ...
  public startRandomMotion(
    ...
    LAppPal.printMessage(`a: ${this._modelSetting.getMotionCount(group)}`);
    LAppPal.printMessage(`no: ${no}`);
