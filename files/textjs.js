...
buttons[0].onclick = function(){		//进入流星视频
	...
	ve.setAttribute('src','./video/3star-single.mp4');
	ve.style.zIndex=2;
...
ve.addEventListener('ended',function(){		//视频播放完毕进入result
	if(ve.style.zIndex == 2){	
		result();
	};
});	
...
var result = function(){
	...
	ve.removeAttribute('scr');
	ve.style.zIndex=-2;
	ve.removeAttribute('autoplay');
