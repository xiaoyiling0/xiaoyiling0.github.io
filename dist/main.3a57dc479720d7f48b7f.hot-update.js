...
function onMouseMoved(e) {
    ...
    var posY = e.clientY - window.innerHeight + exports.canvas.height;
    console.log('页面宽度：', window.innerWidth);
    console.log('鼠标x：', posX);
    posX = (posX < 0) ? 0 : posX;
    posY = (posY < 0) ? 0 : posY;
